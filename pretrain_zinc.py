...
class SmilesFeaturizer(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # The ZINC dataset provides PyG Data objects directly
        # Pass the data object to the featurizer
        mol_data = self.featurizer(data)
        return mol_data
...
def main():
    ...
    zinc = [smiles for smiles in zinc_csv['smiles']]
